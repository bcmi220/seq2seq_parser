...
def model_opts(parser):
    ...
    group.add_argument('-elmo', action="store_true",
                       help="""Concatenate the elmo representations with the hidden state.""")
    group.add_argument('-elmo_size', type=int, default=300,
                       help="""the elmo representations size.""")
    group.add_argument('-elmo_options', help="""the elmo options file.""")
    group.add_argument('-elmo_weight', help="""the elmo weight file.""")

    group.add_argument('-subword_elmo', action="store_true",
                       help="""Concatenate the subword elmo representations with the hidden state.""")
    group.add_argument('-subword_elmo_size', type=int, default=300,
                       help="""the subword elmo representations size.""")
    group.add_argument('-subword_elmo_options', help="""the subword elmo options file.""")
    group.add_argument('-subword_weight', help="""the subword weight file.""")
    group.add_argument('-subword_spm_model', help="""the elmo weight file.""")

    group.add_argument('-node2vec', action="store_true",
                       help="""Concatenate the node2vec embedding with the hidden state.""")
    group.add_argument('-node2vec_emb_size', type=int, default=100,
                       help="""the node2vec embedding size.""")
    group.add_argument('-node2vec_weight', help="""the node2vec weight file.""")
    ...
    group.add_argument('-decoder_type', type=str, default='rnn',
                       choices=['rnn', 'transformer', 'cnn'], #, 'highway'
                       help="""Type of decoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|transformer|cnn].""") #|highway
